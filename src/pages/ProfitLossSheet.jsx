  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setIndents([{ rowData: headers, originalIndex: -1 }, ...filterRowsByFirmAccess(result.pending || [], headers, '/profit-loss-sheet')]);
        setHistoryIndents([{ rowData: headers, originalIndex: -1 }, ...filterRowsByFirmAccess(result.history || [], headers, '/profit-loss-sheet')]);
      } else {
        setIndents([]);
        setHistoryIndents([]);
