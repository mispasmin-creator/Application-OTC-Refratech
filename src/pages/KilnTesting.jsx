  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const pendingRows = filterRowsByFirmAccess((result.pending || []).slice().reverse(), headers, '/kiln-testing');
        const historyRows = filterRowsByFirmAccess((result.history || []).slice().reverse(), headers, '/kiln-testing');
